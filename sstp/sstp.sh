...
touch echo "plughin & account" > /etc/sstp/.sstp.db
...
wget -O /etc/accel-ppp.conf "${babatok}/accel.conf"
sed -i $MYIP2 /etc/accel-ppp.conf
sed -i $MYIP /etc/accel-ppp.conf
sed -i $MYIP /etc/accel.conf
...
#input perintah sstp
#wget -O /usr/bin/addsstp https://${babatok}/addsstp.sh && chmod +x /usr/bin/addsstp
#wget -O /usr/bin/delsstp https://${babatok}/delsstp.sh && chmod +x /usr/bin/delsstp
#wget -O /usr/bin/ceksstp https://${babatok}/ceksstp.sh && chmod +x /usr/bin/ceksstp
#wget -O /usr/bin/renewsstp https://${babatok}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
