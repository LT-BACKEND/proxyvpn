...
# ==================================================
# Link Hosting Kalian
babatok="raw.githubusercontent.com/LT-BACKEND/proxyvpn/memek/ipsec"
...
#wget -O /usr/bin/addl2tp https://${babatok}/addl2tp.sh && chmod +x /usr/bin/addl2tp
#wget -O /usr/bin/dell2tp https://${babatok}/dell2tp.sh && chmod +x /usr/bin/dell2tp
#wget -O /usr/bin/addpptp https://${babatok}/addpptp.sh && chmod +x /usr/bin/addpptp
